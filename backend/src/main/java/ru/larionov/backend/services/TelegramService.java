...
import ru.larionov.backend.exception.CannotSendMessage;
import ru.larionov.backend.exception.CommandNotSupported;
import ru.larionov.backend.exception.NotFoundParameter;
...
import ru.larionov.backend.services.telegram.TelegramHandler;
import ru.larionov.backend.services.telegram.command.CommandHandler;
import ru.larionov.backend.services.telegram.command.CommandService;
...
//    }
    ...
    public void sendNotification(String message) throws CannotSendMessage {
        if (enable){
            User user = userRepository.findAll().get(0);
            tHandler.sendMessage(new SendMessage(user.getChatId().toString(),
